...
const Summary = () => {
  ...
  <span className="font-bold  text-center text-success lg:text-8xl text-6xl" data-from="0" data-to="25" data-speed="1500">5</span>
...
<div class="card w-96 bg-base-300 shadow-xl">
  ...
  <span className="font-bold  text-center text-success lg:text-8xl text-6xl" data-from="0" data-to="25" data-speed="1500">6K+</span>
  <span className="uppercase text-center text-white font-bold lg:text-2xl text-1xl">
		Satisfied</span>
		<span className=" text-center uppercase text-white font-bold lg:text-2xl text-1xl">
		Customers	</span>
...
<div class="card w-96 bg-base-300 shadow-xl">
  ...
  <span className="font-bold  text-center text-success lg:text-8xl text-6xl" data-from="0" data-to="25" data-speed="1500">12</span>
  <span className="uppercase text-center text-white font-bold lg:text-2xl text-1xl">
		earned</span>
		<span className=" text-center uppercase text-white font-bold lg:text-2xl text-1xl">
		awards	</span>
